...
private:
 	int patual,zera,posm,posi,iv,contador,
    i,j,iot,si,z,j0, j1, j2, kk, i1, jj, ii;  
	...
	double Tsup,SQE10,SQE20,SQE30,S1,S2,S3,Med,SQT,SQT1,SQT2,SQT3,R2,me,

           q,qq,q1,q2,q3,r,KE,KW,KP,KN,KS,AE,AW,AN,AS,APO,PME,PMW,PMP,PMN,PMS,dq,Menor =100000000,qot=0,ero=0,te[100][1],
		    dr=R/(L-1),dz=h/(M-1),
